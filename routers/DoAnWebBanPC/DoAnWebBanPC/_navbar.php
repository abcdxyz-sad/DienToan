...
<!-- CSS Links -->
 <link rel="stylesheet" href="Css/navBar.css" disable>
...
<nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <button class="navbar-toggler" title="Mở menu" aria-label="Mở menu" type="button" data-bs-toggle="collapse" data-bs-target="#navbarContent">
            ...
            <!-- Right Side Navigation -->
                ...
                <div class="user-info d-flex align-items-center mx-4 gap-2">
                    ...
                    <span>
                      ...
                      echo "<strong class='bi bi-person-circle nav-link'> Chưa đăng nhập </strong>";
                        }
                        ?>
                    </span>
                </div>
